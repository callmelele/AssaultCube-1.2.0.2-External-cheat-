...
static const int of_viewmatrix = 0x501AE8;
static int of_posx_normal = 0x34;
static int of_posy_normal = 0x38;
static int of_posz_normal = 0x3C;

static int of_crosshair_id = 0x1E4; // This can vary, but 0x14C or 0x1E4 are common for 1.2

// weapons / ammo
static int AR_Ammo = 0x150;
static int Grenade = 0x158;
static int SMG_Ammo = 0x148;
static int Sniper_Ammo = 0x14C;
static int Shotgun_Ammo = 0x144;
static int CB_Ammo = 0x140;
